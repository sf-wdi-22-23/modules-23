...
for (var key in myFirstJSON){
    for (var i = 0; i < myFirstJSON['language basics'][0]['Spanish']['letters'].length; i++){
        if (i === 0){
            console.log('la primera letra es ' + myFirstJSON['language basics'][0]['Spanish']['letters'][i] );
        } else {
            console.log('el proximo letra es ' + myFirstJSON['language basics'][0]['Spanish']['letters'][i] );
        }
    }
}
